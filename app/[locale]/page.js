      ...
      <section className="relative bg-(--color-bg-secondary) px-6 md:px-16 py-16 md:py-24">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-2xl mx-auto space-y-3 mb-12">
            <p className="text-(--color-accent) uppercase tracking-widest text-sm font-medium">What We Do</p>
            <h2 className="text-3xl md:text-4xl font-bold leading-tight">{t.practiceAreasHeading}</h2>
          </div>
              ...
              return (
                ...
                >
                  <div className="w-12 h-12 rounded-full bg-(--color-accent)/10 flex items-center justify-center group-hover:bg-(--color-accent) transition">
                    <Icon size={22} className="text-(--color-accent) group-hover:text-[#111111] transition" />
                  </div>
